...
import (
	...
	"github.com/Manolin89/GuiaGolang/middlew"
	"github.com/Manolin89/GuiaGolang/routers"
...
func Manejadores() {
	...
	router.HandleFunc("/eleminarTweet", middlew.ChequeoBD(middlew.ValidoJWT(routers.EliminarTweet))).Methods("DELETE")
